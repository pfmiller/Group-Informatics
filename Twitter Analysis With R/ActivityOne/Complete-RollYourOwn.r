...
filename=paste(inputfile3, "MARKEDUP.csv")
####write file to a csv
...
linkfile <- paste(inputfile3, "linkpresence.csv")
write.csv(linkpresence, file=linkfile)
...
hashfile <- paste(inputfile3,"hashpresence.csv")
write.csv(hashpresence, file=hashfile)
...
syntacticfeatureoverview <- table(inputfile3, numberoftweets, linkpresencepercentage, hashpresencepercentage, mentionpresencepercentage, replytopresencepercentage, rtpresencepercentage)

filename=paste("syntacticfeatureoverview", inputfile3)
